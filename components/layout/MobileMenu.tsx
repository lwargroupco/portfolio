...
<div className="mt-4">
  <Link
    href="/contact"
    onClick={onClose}
    className="inline-flex w-full items-center justify-center rounded-xl bg-[#075031] px-6 py-4 text-sm font-bold !text-white shadow-md transition hover:bg-[#0b6740]"
  >
