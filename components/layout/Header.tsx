...
<div className="ml-auto hidden shrink-0 items-center xl:flex">
  <Link
    href="/contact"
    className="inline-flex min-w-[190px] items-center justify-center rounded-xl bg-[#075031] px-7 py-4 text-sm font-bold !text-white shadow-md transition duration-200 hover:-translate-y-0.5 hover:bg-[#0b6740] hover:shadow-lg"
  >
